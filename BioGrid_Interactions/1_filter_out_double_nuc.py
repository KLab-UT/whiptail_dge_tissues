...
df = pd.read_csv("Biogrid_filtered_interactions.csv", sep='\t')  # Replace with your actual file name
...
mask = df['Official_Symbol_Interactor_A'].isin(genes_of_interest) | df['Official_Symbol_Interactor_B'].isin(genes_of_interest)
